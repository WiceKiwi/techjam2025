...
from techjam2025.pipelines.rules_baseline import RulesBaselinePipeline
...
def main():
    ...
    ap.add_argument("--config","-c",default=str(ROOT/"configs"/"rules_baseline.yaml"))
    ...
    pipe = RulesBaselinePipeline(cfg, logger=logger)
    pipe.run()
